...
from qbert_modeling import BertForSequenceClassification,QuantumBertForSequenceClassification
...
def main():
    ...
    model = QuantumBertForSequenceClassification.from_pretrained(
